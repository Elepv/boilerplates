...
source "proxmox-iso" "ubuntu-server-jammy" {
    ...
    template_description = "Ubuntu Server 22.04 LTS (Jammy Jellyfish) Image"
...
build {
    ...
    provisioner "shell" {
        # environment_vars = [
        #     "HTTP_PROXY=http://10.0.9.24:7890",
        #     "HTTPS_PROXY=https://10.0.9.24:7890"
        # ]
        inline = [
