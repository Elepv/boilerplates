...
source "proxmox" "ubuntu-server-focal-docker-tmpl" {
    ...
    node = "pve"
    vm_id = "310"
    vm_name = "ubuntu-server-focal-docker-tmpl"
...
build {
    ...
    name = "ubuntu-server-focal-docker-tmpl"
    sources = ["source.proxmox.ubuntu-server-focal-docker-tmpl"]
