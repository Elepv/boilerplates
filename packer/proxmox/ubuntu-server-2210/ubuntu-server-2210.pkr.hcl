...
# !!! 需要修改source名称
source "proxmox" "ubuntu-server-2210-tmpl" {
    ...
    vm_id = "321"
    vm_name = "ubuntu-server-2210-tmpl"
    template_description = "Ubuntu Server 2210 Image"

    # VM OS Settings
    # (Option 1) Local ISO File
    # !!! 修改iso信息
    iso_file = "pve-tns:iso/ubuntu-22.10-live-server-amd64.iso"
    # - or -
...
build {
    ...
    name = "ubuntu-server-2210-tmpl"
    sources = ["source.proxmox.ubuntu-server-2210-tmpl"]
